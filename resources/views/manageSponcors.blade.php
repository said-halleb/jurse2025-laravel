...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title"> Manage Home Sponsors photos
        </h2>
    ...
    <div class="w-full mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form action="{{ route('admin.addSponcor') }}" method="post" enctype="multipart/form-data">
                @csrf
        ...
        <table class="table table-hover table-bordered" style="background: white !important;">
            ...
            <tbody>
                @foreach ($sponcors as $item)
                    <tr>
                        <td>
                            <img src="{{ asset($item->src) }}" alt="{{ $item->alt }}" style="width: 200px; height: 150px;">
                        </td>
                        <td>{{ $item->alt }} </td>
                        ...
                        <td>
                            <form action="{{ route('admin.deleteSponcor', $item->id) }}" method="post" nctype="multipart/form-data">
                                @csrf
                                @method('DELETE')
